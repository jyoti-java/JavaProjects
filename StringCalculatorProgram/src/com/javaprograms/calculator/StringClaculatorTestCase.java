package com.javaprograms.calculator;

import org.junit.Test;
import static org.junit.Assert.assertEquals;

public class StringClaculatorTestCase {
	@Test
	...
	@Test
	public void return_2_when_input_is_2_1001() {
		assertEquals("2", given("2,1001"));
	}
	...
	@Test
	public void return_correct_sum_when_multiple_delimiter_is_used() {
		assertEquals("6", given("//;@\n1;@2;@3"));
	...
	private String given(String number) {
		StringClaculator stringCalculator = new StringClaculator();
